...
if(isset($_SESSION['user'])){
	...
	$sqlIndex=" ALTER TABLE  ".$nombreTabla ;
	if(isset($_POST['unique'])){
		$sqlIndex.=" UNIQUE ";
	}
	$sqlIndex.=" ADD CONSTRAINT ".$_POST['nombreIndice']." PRIMARY KEY (";
	...
	if($columnaSeleccionada){
		$mensaje="La llave $base.$nombreTabla.".htmlspecialchars($_POST['nombreIndice'])." se ha creado correctamente"; 
		//echo $sqlIndex;
		try{
		...
		echo "Ninguna columna seleccionada para la llave";
	}
	}else{
